        ...
        >
          ...
          >
            <Image
              src={profile}
              priority
              alt="Abhay's Profile Picture"
              data-blobity-tooltip="It's me!"
              data-blobity-invert="false"
              className=" w-[200px] rounded-[50%] grayscale hover:grayscale-0 md:w-[200px] md:rounded-[50%] lg:w-[245px]"
            />
          </motion.div>
        </div>
      </div>
      ...
      >
        ...
        >
          <p className="z-50 text-center text-[16px] font-medium text-[#e4ded7] md:text-[20px] lg:text-left">
            Full-Stack Developer and Problem Solver — I specialize in building
            scalable, intelligent, and user-centric applications that blend
